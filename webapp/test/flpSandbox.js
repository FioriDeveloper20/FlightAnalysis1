		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Of Carriers And Flights",
									"targetURL": "#ListOfCarriersAndFlights-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ListOfCarriersAndFlights-display": {
								"semanticObject": "ListOfCarriersAndFlights",
								"action": "display",
								"description": "List Of Carriers And Flights",
								"title": "List Of Carriers And Flights",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=learninghub.learningroom.btp.flightanalysis1",
									"url": sap.ui.require.toUrl("learninghub/learningroom/btp/flightanalysis1")
								}
							}
						}
					}
