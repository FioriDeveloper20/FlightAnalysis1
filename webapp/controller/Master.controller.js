sap.ui.define([
	...
	return BaseController.extend("learninghub.learningroom.btp.flightanalysis1.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "learninghub.learningroom.btp.flightanalysis1.view.ViewSettingsDialog",
					controller: this
